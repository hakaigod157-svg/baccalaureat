...
<body>
    ...
    <div class="container" style="max-width: 600px; margin: 0 auto; padding-top: 50px;">
        <div class="form-card">
            ...
            <form action="${pageContext.request.contextPath}/serie/sauvegarder" method="POST">
                
                <c:if test="${not empty serie.idSerie}">
                    <input type="hidden" name="idSerie" value="${serie.idSerie}">
                </c:if>

                <div class="form-group">
                    <label class="form-label" for="libelle">Libellé :</label>
                    <input type="text" id="libelle" name="libelle" class="form-input" value="${serie.libelle}" required>
                </div>

                <div class="form-actions" style="margin-top: 30px;">
                    <button type="submit" class="btn btn-primary">Enregistrer</button>
                    <a href="${pageContext.request.contextPath}/serie/liste" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
