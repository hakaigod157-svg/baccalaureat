...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <form:form action="${pageContext.request.contextPath}/statut/sauvegarder" method="post" modelAttribute="statut">
                <form:hidden path="idStatut" />
                ...
                <div class="form-actions">
                    ...
                    <a href="${pageContext.request.contextPath}/statut/liste" class="btn btn-secondary">Annuler</a>
                </div>
            </form:form>
        </div>
    </div>
